	...
	<div class="options-container">
		<div class="options-container-content">
			...
			<div class="options-th-container flex">
				...
				<input type="text" class="middle-position options-input options-input-trade-money" value="" name="amount" id="txnAmts" />
				<input type="text" class="right-position options-input options-input-fee-money" value="" name="fee_amount" id="inFee" />
			</div>
			<div class="options-th-container flex">
			...
			<div class="options-th-container flex">
				...
				<input type="text" class="middle-position options-input options-input-name" value="" name="customer_name" id="customerNm" />
				<select class="options-select-container right-position" id="status">
                ...
                <div class="options-th-container flex">
                    <input type="text" class="left-position options-input options-input-order" value="" name="orderId" id="orderid" />
