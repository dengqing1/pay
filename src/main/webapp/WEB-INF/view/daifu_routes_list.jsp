...
<body>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">代付新增备份</h4>
	      </div>
	      <div class="modal-body">
	        <form class="form-horizontal" id="routesAddModal_form">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="gateway" id="channelAbbr_add_input">
			      		<option>--请选择--</option>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="cardType" id="channelAbbr_add_input">
			      		<option>--请选择--</option>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="feeType" id="channelAbbr_add_input">
			      		<option>--请选择--</option>
	...
	<!--用户编辑的模态框 -->
	<div class="modal fade" id="daifurouteseditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
	        <form class="form-horizontal" id="daifurouteseditModal_form">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	        <button type="button" class="btn btn-primary" id="daifuRoutes_update_btn">跟新</button>
	      </div>
	    </div>
	  </div>
	</div>
		...
		<div class="row">
			<div class="col-md-12">
					...
					<c:forEach items="${list}" var="l" varStatus="state">
		                <tr>
		                     ...
		                     <td width="10%" align="center">
	                           <a onclick="daifuupdateRouter(${l.merchantId},'${l.channelAbbr}','${l.channelMerId}','${l.routes_gateway}','${l.routes_card_type}')">修改</a>
	                        </td>
		                  </tr>
		             </c:forEach>
				</table>
				...
				<div class="ui circular labels" style="text-align:center">
				    ...
				    <a class="ui label" href="../daifuroutes/routeslist.do?page=1">首页</a>
				    <c:if test="${pageInfo.hasPreviousPage}">
				    	<a class="ui label" href="../daifuroutes/routeslist.do?page=${pageInfo.pageNum-1}">上一页</a>
				    </c:if>
				    
				    <c:if test="${pageInfo.hasNextPage}">
				    	<a class="ui label" href="../daifuroutes/routeslist.do?page=${pageInfo.pageNum+1}">下一页</a>
				    </c:if>
				    <a class="ui label" href="../daifuroutes/routeslist.do?page=${pageInfo.pages}" >末页</a>
				</div>
				<!-- 分页 end-->
			</div>
		</div>
    ...
    <script type="text/javascript">
		...
		$("#channelAbbr_add_input").change(function(){debugger;
			var channelAbbr = $("#channelAbbr_add_input").val();
			 $.ajax({
	   		        url: "../daifuroutes/daifuRoutesEdit.do",
	   		        type: "GET",
		...
		$("#routes_save_btn").click(function(){
			...
			$.ajax({
   		        url: "../daifuhistory/saveRoutes.do",
   		        type: "POST",
		...
		//修改
		$("#daifuRoutes_update_btn").click(function(){
			 $.ajax({
   		        url: "../daifuhistory/updateRoutes.do",
   		        type: "POST",
   		        data:$("#daifurouteseditModal_form").serialize(),
   		        dataType: "json",
   		        success: function (result) {
   		        	if(result.code == 100){
	   		            alert("保存成功!");
		...
		//修改弹出框
		function daifuupdateRouter(merchantId,channelAbbr,channelMerId,routes_gateway,routes_card_type){
			$.ajax({
				url:"../daifuroutes/updateDaifuRouter.do?merchantid="+merchantId+"&channelabbr="+channelAbbr+"&channelmerid="+channelMerId+
