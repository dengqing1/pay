	...
	<form class="layui-form" style="width: 40%;padding-top: 20px;">
		<div class="layui-form-item">
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="balanceAvailable" readonly="readonly" id="input_available" required  lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		 </div>
		 <div class="layui-form-item">
		 ...
		 <div class="layui-form-item">
		    <label class="layui-form-label">解冻金额(元) </label>
		    <div class="layui-input-block">
		      <input type="text" name="jiedong" id="jiedong_input" required  lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		 </div>
	...
	<script type="text/javascript">
		...
		layui.use(['form'], function() {
			...
			form.on('submit(formDemo)', function(data) {
		   			...
		   			//解冻金额
		   			var dongjie = $("#jiedong_input").val();
		   			//解冻金额>已冻结资金
		   			if(parseInt(dongjie) > parseInt(balance)){
		   				alert("余额不足");
		   			}else{
		   				...
		   				if($("#input_mima").val() != "654321"){
				   			...
				   			$.ajax({
				   		        url: "saveThaw.do",
				   		        type: "POST",
				   		        data:{balance:available,ydjzj:balance,jiedong:dongjie,id:id,name:name},
				   		        dataType: "json",
				   		        success: function (result) {
				   		            alert("保存成功!");
				   		        	location.reload();
