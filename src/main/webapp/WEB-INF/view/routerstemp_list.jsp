		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="ui circular labels" style="text-align:center">
				    ...
				    <a class="ui label" href="../temp/templist.do?page=1">首页</a>
				    <c:if test="${pageInfo.hasPreviousPage}">
				    	<a class="ui label" href="../temp/templist.do?page=${pageInfo.pageNum-1}">上一页</a>
				    </c:if>
				    
				    <c:if test="${pageInfo.hasNextPage}">
				    	<a class="ui label" href="../temp/templist.do?page=${pageInfo.pageNum+1}">下一页</a>
				    </c:if>
				    <a class="ui label" href="../temp/templist.do?page=${pageInfo.pages}" >末页</a>
				</div>
				<!-- 分页 end-->
			</div>
		</div>
