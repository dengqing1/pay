...
//        checkArgument(privateKey != null, "The privateKey must be not null");
     ...
     */
    public static String signBase64( String content,  PrivateKey privateKey,  Charset charset) {
     ...
     * @return 返回签名数据（Base64格式）
     */
    public static String signBase64( String content,  PrivateKey privateKey) {
    ...
    public static boolean verify(
             String content,  String signText,
